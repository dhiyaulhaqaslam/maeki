    ...
    return (
        ...
        >
            ...
            {menuOpen && (
                ...
                >
                    <a href="#hero" onClick={() => setMenuOpen(false)} className="block">Beranda</a>
                    <a href="#budaya" onClick={() => setMenuOpen(false)} className="block">Budaya</a>
                    <a href="#warisan" onClick={() => setMenuOpen(false)} className="block">Warisan</a>
                    <a href="#kontak" onClick={() => setMenuOpen(false)} className="block">Kontak</a>
                </motion.div>
            )}
        </motion.nav>
    );
